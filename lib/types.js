...
export const MSG = {
  ...
  RESUME_SESSION: 'RESUME_SESSION', // sidepanel -> background：继续某条历史会话（复用其 sessionId，并重建多轮上下文）
...
PREVIEW_RULE: 'PREVIEW_RULE',
  ...
  EXPORT_TRACE: 'EXPORT_TRACE', // sidepanel -> background：导出本轮任务的模型输入/输出 trace（供分析）
};
